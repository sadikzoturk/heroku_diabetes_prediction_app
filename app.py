...
model = pickle.load(open('classifier.pkl', 'rb')) #kayitli modeli cagirma
...
def predict():
    ...
    return render_template('template.html', prediction_text='DiabetePredicted Diabete: {}'.format(prediction))
